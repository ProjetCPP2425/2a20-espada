...
void LoginWindow::on_loginButton_clicked()
{
    ...
    if (query.next()) {
        ...
        if (currentTask == "employe") {
            ...
            mainWindow->setRdvBoxVisible(false);    // Hide RDV-related UI
            mainWindow->setEmpBoxVisible(false);    // Hide employee-related UI
            mainWindow->setClientBoxVisible(false); // Hide client-related UI
            mainWindow->setResBoxVisible(true);     // Show reservation-related UI
            ...
            mainWindow->setEmpBoxVisible(false);    // Hide employee-related UI
            mainWindow->setClientBoxVisible(false); // Hide client-related UI
            mainWindow->setResBoxVisible(false);
            mainWindow->setprojetBoxVisible(true);
            // Show reservation-related UI
